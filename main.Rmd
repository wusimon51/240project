...
---
## RECENT REVISIONS: add recent revisions you made, once someone else sees this, they can delete previous revisions and add new things if needed

- Modified Introduction
- Added source + limitation section
...
### Question 1
- For Amazon and non-Amazon (partner) products that ranked in top 10 search, what is the distribution of review amounts? 
```{r}
# Filter data
amazon_10 = amazon %>% 
  filter(amazon <= 10) %>% 
