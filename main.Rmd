...
- Setting threshold at n = 3, meaning if a amazon product shows up in the first 3 results, we can consider it a general product, and if n > 3, then the product can be considered specific.
