...
Using this data, we came up with three research questions to help us explore the characteristics that define an amazon search. Does what you search matter in terms of product ranking? Can we assume the type of search by simply looking at the product's ranking, stars and reviews on Amazon? How do Amazon's products compare to those marketed by non-Amazon retailers?
